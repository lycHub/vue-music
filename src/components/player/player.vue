        ...
        @touchend="middleTouchEnd">
          ...
          <scroll class="middle-r" ref="lyricList">
            <div class="lyric-wrapper">
              <div>
                <p class="text">fasdasdasdasdada</p>
                <p class="text">fasdasdasdasdada</p>
                <p class="text">fasdasdasdasdada</p>
                <p class="text">fasdasdasdasdada</p>
                <p class="text">fasdasdasdasdada</p>
...
-->
        ...
        <div class="bottom">
          ...
          <div class="operators">
            <div class="iocn i-left" @click="changeMode">
              <i :class="iconMode"></i>
            </div>
            <div class="iocn i-left" @click="prev" :class="disableCls">
              <i class="icon-prev"></i>
            </div>
            <div class="iocn i-center" @click="togglePlaying" :class="disableCls">
              <i :class="playIcon"></i>
            </div>
            <div class="iocn i-right" @click="next" :class="disableCls">
              <i class="icon-next"></i>
            </div>
            <div class="iocn i-right">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      // 当改变播放模式后，重新设置当前播放歌曲的索引
      resetCurrentIndex(list) {
        // 当前歌曲的新索引
        const newIndex = list.findIndex(item => item.id === this.currentSong.id)
      ...
      middleTouchEnd() {
        ...
        if (this.currentShow === 'cd') {
          // 向左滑，如果滑动百分比大于1%，就让它完全划过去，否则就让它回去
      ...
      // 获取mini中左下角icon的位置和缩放比例
      _getPosAndScale() {
        const targetWidth = 40    // icon宽度
        const paddingLeft = 40    // icon中心距左边界的距离
        const paddingBottom = 30    // icon中心距下边界的距离
        const paddingTop = 80       // 中部(middle)距顶部(top的height)
        const width = window.innerWidth * 0.8   // 中间圆形cd的宽度
