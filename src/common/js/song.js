...
export function createSong(musicData) {
  return new Song({
    ...
    url: `http://dl.stream.qqmusic.qq.com/C400${musicData.strMediaMid}.m4a?vkey=B05D7452C615DB44792A981C7B661A65D7DA1E54C264A2B5C38617A5B524821DEB81D3C557DEB3450658A50090062CFCA7F0271E7E352595&guid=8777127740&uin=1120805364&fromtag=66`
  })
}


// 歌手singer的api返回数据的个数组但我们只需显示他的名字就行了
